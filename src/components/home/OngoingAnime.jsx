...
const OngoingAnime = () => {
    const { data: ongoingData, loading, error } = useFetch('ongoing');

    if (loading || error || !ongoingData?.data?.animeList) return null;

    const animeList = ongoingData.data.animeList;

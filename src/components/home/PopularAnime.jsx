...
const PopularAnime = () => {
    const { data: popularData, loading, error } = useFetch('popular');

    if (loading || error || !popularData?.data?.animeList) return null;

    const animeList = popularData.data.animeList;

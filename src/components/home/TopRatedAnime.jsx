...
const TopRatedAnime = () => {
    const { data: topRatedData, loading, error } = useFetch('top_rated');

    if (loading || error || !topRatedData?.data?.animeList) return null;

    const animeList = topRatedData.data.animeList;

...
<body>
    ...
    <main style="gap: 20px;">
        <div class="ongoing">
            ...
            <div class="home-list">
                <?php 
                foreach($row['anime_list'] as $rows){
                ?>
                <a href="<?= $root ?>anime/<?= $rows['slug'] ?>" class="data">
                    <img src="<?= $rows['poster'] ?>">
                    <div class="text">
                        <p id="date" style="display: flex;justify-content:space-between;"></p>
                        <p id="name"><?= $rows['title'] ?></p>
                    </div>
                </a>
                <?php
                }
